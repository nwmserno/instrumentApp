// File: Pretest/CheckCompletion.js
const express = require('express');
const router = express.Router();

module.exports = (supabase, authenticateToken) => {
  
  router.get('/check-pretest-complete', authenticateToken, async (req, res) => {
    ...
    try {
      ...
      // ✅ [แก้ไข] แก้ไขชื่อตารางและคอลัมน์ให้ถูกต้อง (ลบ 's' ที่เกินมา)
      ...
      console.error('❌ Unexpected server error in /check-pretest-complete:', err.message);
